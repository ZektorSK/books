...
export default defineComponent({
  ...
  data(){
      return{
          TW_link:'font-sans lg:text-xl text-lg font-semibold hover:underline hover:decoration-amber-500 hover:decoration-2 hover:text-amber-900 hover:cursor-pointer select-none'
      }
  }
});
</script>
