<template>
    <div class="flex flex-col justify-center items-center">
        <article class="flex flex-col justify-center items-center mt-8 max-w-[800px]">
            ...
            <figure class="mt-8">
                <figcaption class="font-mono font-bold text-4xl uppercase text-center text-amber-900 border-4 border-amber-500 p-2 m-2">METRO 2033</figcaption>
                <img src="../assets/book_metro.jpg" class="h-[350px] w-[250px] border-b-4 border-amber-500 shadow-lg" title="METRO 2033" alt="The book cover of METRO 2033">
            </figure>
